...
#include "PQL/QueryEvaluator/RelationEvaluator/AffectsBipTEvaluator.h"
#include "PKB/PKB.h"
...
namespace UnitTesting {
	...
	TEST_F(AffectsBipTEvaluatorTest, evaluateWildAndWild) {
		PKB::getInstance().resetCache();
	...
	TEST_F(AffectsBipTEvaluatorTest, evaluateConstantAndWild) {
	...
	TEST_F(AffectsBipTEvaluatorTest, evaluateWildAndConstant) {
